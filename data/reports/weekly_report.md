...
## 本周高价值事件
- Rcarmo/go-AI: A mildly sane inference API library for go｜来源等级 T2｜Hacker News AI 围绕 Hacker News AI 推出新的 API 或 SDK 能力，重点强化开发者集成和工作流接入。｜主源: https://github.com/rcarmo/go-ai
