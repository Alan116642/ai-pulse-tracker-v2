...
## 本周高价值事件
- ANP – A binary protocol for AI agent-to-agent price negotiation (no LLM tokens)｜来源等级 T2｜Hacker News AI 正在强化 Hacker News AI 的 Agent 工作流能力，说明产品形态继续向可执行任务链路演进。｜主源: https://github.com/victornominista/anp
